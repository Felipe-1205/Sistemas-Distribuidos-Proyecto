...
class Comprobacion implements Runnable {
    ...
    public void run() {
        try (ServerSocket serverSocket = new ServerSocket(10040)) {
            ...
            }, 0, 2000); // Envía un heartbeat cada 2 segundos
...
class Humo implements Runnable {
    ...
    public void run() {
        ...
        try (ZContext context = new ZContext()) {
            ...
            pullSocket.bind("tcp://10.43.100.213:10000");
...
class Temperatura implements Runnable {
    ...
    public void run() {
        ...
        try (ZContext context = new ZContext()) {
            ZMQ.Socket pullSocket = context.createSocket(SocketType.PULL);
            pullSocket.bind("tcp://10.43.100.213:10005");
...
class Humedad implements Runnable {
    ...
    public void run() {
        ...
        try (ZContext context = new ZContext()) {
            ZMQ.Socket pullSocket = context.createSocket(SocketType.PULL);
            pullSocket.bind("tcp://10.43.100.213:10010");
